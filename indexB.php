...
if (isset($_SESSION['login'])) {
    ...
    die("Can't Access, please <a href='admin/login.php'>Login here</a>");
}
                        ...
                        <div class="row form-row mb-1">
                            ...
                            <div class="col-md-4">
                                <div class="form-label-group">
                                    ...
                                    <a href="index.php" class="btn btn-primary">Kelas 5A</a>
                                    <a href="indexB.php" class="btn btn-success">kelas 5B</a>
