...
$nameErr = $emailErr = $passErr = $roleErr = $imageErr = "";
$name = $email = $pass = $confpass = $role = $image = "";
$valid_email = $valid_name = $valid_password = $valid_role = $valid_image = false;
          ...
          <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="password" name="pass" id="inputPassword" class="form-control" placeholder="Password" value="<?php echo $pass; ?>">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="password" name="confpass" id="confirmPassword" class="form-control" placeholder="Confirm password" value="<?php echo $confpass; ?>">
