...
<body>
                    ...
                    <form method="post" action="">
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" name="email" id="Email" class="form-control" placeholder="Email" value="<?php echo $nemail; ?>" readonly>
                                <label for="Email">Email</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" name="name" id="Fullname" class="form-control" placeholder="Full name" value="<?php echo $nname; ?>">
    ...
    if ($valid_name && $valid_password && $valid_role == true) {
        include 'updateusers_action.php';
    }
