                    ...
                    <form method="post" action="">
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" name="nim" id="NIM" class="form-control" placeholder="NIM" value="<?php echo $nnim; ?>" readonly>
                                <label for="NIM">NIM</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" name="nama" id="Fullname" class="form-control" placeholder="Full name" value="<?php echo $nnama; ?>">
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" name="kelas" id="Kelas" class="form-control" placeholder="Full name" value="<?php echo $nkelas; ?>">
